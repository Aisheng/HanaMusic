...
import com.example.aisheng.hanamusic.activity.DownActivity;
import com.example.aisheng.hanamusic.net.HttpUtil;
import com.example.aisheng.hanamusic.provider.DownFileStore;
...
public class DownService  extends Service {
    ...
    public static final String ADD_DOWNTASK = "com.example.aisheng.hanamusic.downtaskadd";
    public static final String ADD_MULTI_DOWNTASK = "com.example.aisheng.hanamusic.multidowntaskadd";
    public static final String CANCLE_DOWNTASK = "com.example.aisheng.hanamusic.cacletask";
    public static final String CANCLE_ALL_DOWNTASK = "com.example.aisheng.hanamusic.caclealltask";
    public static final String START_ALL_DOWNTASK = "com.example.aisheng.hanamusic.startalltask";
    public static final String RESUME_START_DOWNTASK = "com.example.aisheng.hanamusic.resumestarttask";
    public static final String PAUSE_TASK = "com.example.aisheng.hanamusic.pausetask";
    public static final String PAUSE_ALLTASK = "com.example.aisheng.hanamusic.pausealltask";

    public static final String UPDATE_DOWNSTAUS = "com.example.aisheng.hanamusic.updatedown";
    public static final String TASK_STARTDOWN = "com.example.aisheng.hanamusic.taskstart";
    public static final String TASKS_CHANGED = "com.example.aisheng.hanamusic.taskchanges";
    ...
    private Notification getNotification(boolean complete) {
        ...
        nowPlayingIntent.setComponent(new ComponentName("com.example.aisheng.hanamusic", "com.example.aisheng.hanamusic.activity.DownActivity"));
